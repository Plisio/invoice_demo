...
<div
  ...
  data-invoice-shop"<?php echo htmlspecialchars($order['currency']); ?>"
>
    <?php if (in_array($order['status'], ['new', 'pending'])): ?>
      <div class="invoice__progress">
        <div
          ...
          aria-valuemax="100"
          style="width: 0"
          data-expire-utc="<?php echo (int)$order['expire_utc']; ?>"
        >
        ...
        <div class="invoice__formGroup">
          <div class="invoice__inputGroup">
            ...
            >
              ...
              <div class="invoiceTooltip__content">Value copied</div>
            </span>
          </div>
        </div>
...
<script src="/assets/js/run-invoice.js"></script>
